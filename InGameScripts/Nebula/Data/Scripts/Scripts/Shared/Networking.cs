...
namespace Scripts.Shared
{
    ...
    public class Sync<T, Z> where Z : MyGameLogicComponent
    {
        ...
        public Sync(ushort port, Func<Z, T> getter, Action<Z, T, ulong, bool> _handler, Action<T, ulong, bool> _handler2 = null)
        {
            this.port = port;
        ...
        public Sync(ushort port, Func<Z, T> getter, Action<Z, T, byte, ulong, bool> handler, Action<T, byte, ulong, bool> handler2 = null)
        {
            this.port = port;
            this.handler = handler;

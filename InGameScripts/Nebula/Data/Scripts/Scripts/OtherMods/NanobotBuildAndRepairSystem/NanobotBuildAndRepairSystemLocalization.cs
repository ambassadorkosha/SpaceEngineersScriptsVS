namespace SpaceEquipmentLtd.NanobotBuildAndRepairSystem
{
   ...
   public static class Texts {
      ...
      public readonly static MyStringId Color_SetCurrentWeldIgnoreColor;
      public readonly static MyStringId Color_SetCurrentGrindIgnoreColor;
      ...
      static Texts()
      {
         ...
         Color_SetCurrentWeldIgnoreColor = LocalizationHelper.GetStringId(texts, "Color_SetCurrentWeldIgnoreColor");
         Color_SetCurrentGrindIgnoreColor = LocalizationHelper.GetStringId(texts, "Color_SetCurrentGrindIgnoreColor");
            ...
            { MyLanguagesEnum.English, new Dictionary<string, string>
               {
                  ...
                  {"Color_SetCurrentWeldIgnoreColor",            "Get Weld Ignore Color"},
                  {"Color_SetCurrentGrindIgnoreColor",            "Get Grind Color"},
            ...
            { MyLanguagesEnum.Russian,  new Dictionary<string, string>
               {
                  ...
                  {"Color_SetCurrentWeldIgnoreColor",            "Цвет игнорирования сварки"},
                  {"Color_SetCurrentGrindIgnoreColor",            "Цвет распиливания"},

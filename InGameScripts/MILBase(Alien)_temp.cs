        ...
        public void Main(string args)
        {
            ...
            if (pereinit == false)
            {
                ...
                Cargo_with_ore = CargoContainers_all_list.FindAll(x => x.CustomName.Contains("Руда")).ConvertAll(x => (IMyCargoContainer)x);                                                        //Все конты, содержащие лёд
        ...
        public int Rename (List<IMyTerminalBlock> list, string name, bool ShowInTerminal, bool ShowInToolbarConfig, bool ShowInInventory, int list_count, bool use_id)
        {
            foreach (var i in list)
            {
                //Отображенеи в терминале
                {
                    if (ShowInTerminal)
                    {
                        if (i.ShowInTerminal == false)
                        {
                            i.ShowInTerminal = true;
                        }
                    }
                    else
                    {
                ...
                //Отображение в инвентаре
                {
                    if (ShowInInventory)
                    {
                        if (i.ShowInInventory == false)
                        {
                            i.ShowInInventory = true;
                        }
                    }
                    else
                    {
                        if (i.ShowInInventory == true)
                        {
                            i.ShowInInventory = false;
                        }
                    }
                }
                //Отображение в панели инструментов
                {
                    if (ShowInToolbarConfig)
                    {
                        if (i.ShowInToolbarConfig == false)
                        {
                            i.ShowInToolbarConfig = true;
                        }
                    }
                    else
                    {
